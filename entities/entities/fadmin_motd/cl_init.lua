...
function ENT:LoadPage()
    ...
    elseif string.lower(string.sub(Page, -4)) == ".txt" and string.lower(string.sub(Page, 1, 5)) == "data/" then
        -- If it's a text file somewhere in data...
...
function ENT:Initialize()
    ...
    timer.Simple(0, function()
        -- Fix areas of the FAdmin scoreboard coming unclickable
...
function ENT:Draw()
    ...
    if isUsing and posX > -500 and posX < 500 and posY < 250 and posY > -250 and not self.Disabled and self.HTML and self.HTML:IsValid() and self.CanClickAgain and CurTime() > self.CanClickAgain then
        self.CanClickAgain = CurTime() + 1
        self.HTML:SetPaintedManually(false)
