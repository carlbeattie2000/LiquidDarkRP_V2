...
if CLIENT then
  ...
  language.Add("Tool.keypad_adv.desc", "Creates a keypad with more advanced controls.");
  language.Add("Tool.keypad_adv.0", "Left Click: Spawn a Keypad   Right Click: Update Keypad with settings");
end
...
function TOOL:LeftClick(tr)
  ...
  undo.Create("Keypad");
  if util.tobool(self:GetClientNumber("freeze")) then Keypad:GetPhysicsObject():EnableMotion(false); end
