...
function SWEP:Initialize()
  ...
  if self.Primary.Automatic then self.FireMode = "auto"; end
end
...
function SWEP:Holster()
  ...
  if self:GetIronsights() then GAMEMODE:SetPlayerSpeed(self.Owner, GAMEMODE.Config.walkspeed, GAMEMODE.Config.runspeed); end
  return true;
end
...
function SWEP:PrimaryAttack(partofburst)
  ...
  if self.FireMode ~= "burst" then self.Weapon:SetNextPrimaryFire(CurTime() + self.Primary.Delay); end
