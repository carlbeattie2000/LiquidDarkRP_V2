...
function SWEP:SecondaryAttack()
  ...
  if self.ScopeLevel == nil then self.ScopeLevel = 0; end
  if self.ScopeLevel == 0 then
    if SERVER then self.Owner:SetFOV(25, 0); end
    self.ScopeLevel = 1;
    self.Ironsights = true;
  else
    if self.ScopeLevel == 1 then
      if SERVER then self.Owner:SetFOV(5, 0); end
      self.ScopeLevel = 2;
      self.Ironsights = true;
    else
      if SERVER then self.Owner:SetFOV(0, 0); end
      self.ScopeLevel = 0;
