...
---------------------------------------------------------]]
function SWEP:Think()
  if self.data.init then self.data.init = nil; end
...
PrimaryAttack
---------------------------------------------------------]]
--local oldPriAttack = SWEP.PrimaryAttack
function SWEP:PrimaryAttack()
  if not self.Owner:KeyDown(IN_USE) then
    --This gun essentially had copy pasta of weapon_real_base. No longer.
...
function SWEP:SecondaryAttack()
  if not IsFirstTimePredicted() then --Resolve server-client desync issue
    return;
  end
