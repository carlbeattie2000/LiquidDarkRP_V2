    ...
    timer.Simple(.01, function()
      ...
      local function ButtonFunc()
        for k, v in pairs(player.GetAll()) do
          if v:UniqueID() == SID then B.AddPlayer((Section == "players" and "friends") or "players", Playa); end
        end
      ...
      Add.DoClick = function()
        if Section ~= "players" then
          ...
          Txt:SetPos(0, 25);
          Txt:SetSize(400, 20);
          Txt.Paint = function() draw.SimpleTextOutlined("Are you sure you want to remove " .. Name .. "?", (string.len(Name) > 10 and "Trebuchet18") or "Trebuchet22", 200, 10, Color(255, 255, 255, 210), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 2, Color(0, 0, 0, 150)); end;
