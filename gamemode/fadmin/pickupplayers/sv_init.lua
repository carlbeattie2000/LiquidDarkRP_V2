...
hook.Add("PhysgunPickup", "FAdmin_PickUpPlayers", function(ply, ent)
  ...
  if tobool(GetConVarNumber("PlayersCanPickUpPlayers")) or tobool(GetConVarNumber("AdminsCanPickUpPlayers")) and FAdmin.Access.PlayerHasPrivilege(ply, "PickUpPlayers", ent) and tobool(ply:GetInfo("cl_pickupplayers")) then
