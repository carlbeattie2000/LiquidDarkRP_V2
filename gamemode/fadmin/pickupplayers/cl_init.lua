...
FAdmin.StartHooks["PickUpPlayers"] = function()
  ...
  FAdmin.ScoreBoard.Server:AddPlayerAction(function() return (tobool(GetConVarNumber("AdminsCanPickUpPlayers")) and "Disable" or "Enable") .. " Admin>Player pickup"; end, function() return "FAdmin/icons/PickUp", tobool(GetConVarNumber("AdminsCanPickUpPlayers")) and "FAdmin/icons/disable"; end, Color(0, 155, 0, 255), true, function(button)
  ...
  FAdmin.ScoreBoard.Server:AddPlayerAction(function() return (tobool(GetConVarNumber("PlayersCanPickUpPlayers")) and "Disable" or "Enable") .. " Player>Player pickup"; end, function() return "FAdmin/icons/PickUp", tobool(GetConVarNumber("PlayersCanPickUpPlayers")) and "FAdmin/icons/disable"; end, Color(0, 155, 0, 255), true, function(button)
