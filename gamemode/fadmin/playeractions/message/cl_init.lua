...
FAdmin.StartHooks["zzSendMessage"] = function()
  ...
  FAdmin.ScoreBoard.Player:AddActionButton("Send message", "FAdmin/icons/Message", Color(0, 200, 0, 255), function(ply) return FAdmin.Access.PlayerHasPrivilege(LocalPlayer(), "Message"); end, function(ply, button) MessageGui(ply); end);
end;
