FAdmin.StartHooks["Jail"] = function()
  ...
  FAdmin.ScoreBoard.Main.AddPlayerRightClick("Jail", function(ply) RunConsoleCommand("_FAdmin", "jail", ply:SteamID()); end);
  FAdmin.ScoreBoard.Player:AddActionButton(function(ply)
  ...
  end, Color(255, 130, 0, 255), function(ply) return FAdmin.Access.PlayerHasPrivilege(LocalPlayer(), "Jail", ply); end, function(ply, button)
    if ply:FAdmin_GetGlobal("fadmin_jailed") then
      RunConsoleCommand("_FAdmin", "unjail", ply:SteamID());
    ...
    for k, v in pairs(FAdmin.PlayerActions.JailTypes) do
      ...
      FAdmin.PlayerActions.addTimeSubmenu(menu, v .. " jail", function()
