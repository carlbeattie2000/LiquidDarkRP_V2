FAdmin.StartHooks["Ragdoll"] = function()
  ...
  FAdmin.ScoreBoard.Player:AddActionButton(function(ply)
  ...
  end, Color(255, 130, 0, 255), function(ply) return FAdmin.Access.PlayerHasPrivilege(LocalPlayer(), "Ragdoll", ply); end, function(ply, button)
    ...
    for k, v in pairs(FAdmin.PlayerActions.RagdollTypes) do
      ...
      FAdmin.PlayerActions.addTimeSubmenu(menu, v, function()
