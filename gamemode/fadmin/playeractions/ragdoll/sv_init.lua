...
local function Ragdoll(ply, cmd, args)
  ...
  for _, target in pairs(targets) do
    ...
    if IsValid(target) then
      ...
      if not string.find(RagdollType, "kick") and RagdollType ~= "unragdoll" and string.lower(cmd) ~= "unragdoll" then target:FAdmin_SetGlobal("fadmin_ragdolled", true); end
    end
  end
...
hook.Add("PlayerSpawnObject", "FAdmin_ragdoll", function(ply) if type(ply.FAdminRagdoll) == "table" or IsValid(ply.FAdminRagdoll) then return false; end end);
hook.Add("CanPlayerSuicide", "FAdmin_ragdoll", function(ply) if type(ply.FAdminRagdoll) == "table" or IsValid(ply.FAdminRagdoll) then return false; end end);
