local function Freeze(ply, cmd, args)
  ...
  for _, target in pairs(targets) do
    if not FAdmin.Access.PlayerHasPrivilege(ply, "Freeze", target) then
...
hook.Add("PlayerSpawnObject", "FAdmin_jail", function(ply) if ply:FAdmin_GetGlobal("FAdmin_frozen") then return false; end end);
