...
function FAdmin.ScoreBoard.Player.Show(ply)
  ...
  if FAdmin.ScoreBoard.Player.Controls.AvatarLarge and FAdmin.ScoreBoard.Player.Controls.AvatarLarge:IsValid() and FAdmin.ScoreBoard.Player.Controls.AvatarLarge.Player == ply then FAdmin.ScoreBoard.Player.Controls.AvatarLarge:SetVisible(true); end
  ...
  if ValidPanel(FAdmin.ScoreBoard.Player.Controls.InfoPanel1) then FAdmin.ScoreBoard.Player.Controls.InfoPanel1:Remove(); end
  ...
  FAdmin.ScoreBoard.Player.Controls.InfoPanel2:SetPos(FAdmin.ScoreBoard.X + 25 + 184, --[[+ Avatar]]
    FAdmin.ScoreBoard.Y + 100);
