...
hook.Add("ChatTextChanged", "FAdmin_Chat_autocomplete", function(text)
  ...
  hook.Add("HUDPaint", "FAdmin_Chat_autocomplete", function()
    ...
    if targets then draw.WordBox(4, xPos, ChatBoxPosY + i * 24, "Targets: " .. targets, "UiBold", Color(255, 125, 0, 200), Color(255, 255, 255, 255)); end
    if DidMakeShorter then draw.WordBox(4, xPos, ChatBoxPosY + i * 24, "...", "UiBold", Color(0, 0, 0, 200), Color(255, 255, 255, 255)); end
  end);
end);
