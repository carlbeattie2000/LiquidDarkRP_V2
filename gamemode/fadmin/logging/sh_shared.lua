...
FAdmin.StartHooks["Logging"] = function()
  ...
  FAdmin.ScoreBoard.Server:AddServerSetting(function() return (tobool(GetConVarNumber("FAdmin_logging")) and "Disable" or "Enable") .. " Logging"; end, function() return "FAdmin/icons/Message", tobool(GetConVarNumber("FAdmin_logging")) and "FAdmin/icons/disable"; end, Color(0, 0, 155, 255), true, function(button)
