...
hook.Add("CalcMainActivity", "darkrp_animations", function(ply, velocity)
  -- Using hook.Add and not GM:CalcMainActivity to prevent animation problems
...
local function AnimationMenu()
  ...
  for k, v in pairs(Anims) do
    ...
    button:SetText(k);
    button.DoClick = function() RunConsoleCommand("_DarkRP_DoAnimation", v); end;
  end
