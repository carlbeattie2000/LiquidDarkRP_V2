...
function imgui.ExpandRenderBoundsFromRect(x, y, w, h)
    ...
    if IsValid(ent) then
        ...
        if _devMode then print("[IMGUI] Attempted to update renderbounds when entity is not valid!! ", debug.traceback()) end
    end
end
...
function imgui.GetMultiLineTextSize(text, font)
