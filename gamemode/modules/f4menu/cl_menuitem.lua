...
function PANEL:Paint(w, h)
    ...
    draw.RoundedBoxEx(4, h, h - 10 + y, w - h + x, 10, self.DarkRPItem and self.DarkRPItem.buttonColor or not disabled and (self:GetBorderColor() or black) or darkgray, false, false, false, true)
    -- the colored bar
