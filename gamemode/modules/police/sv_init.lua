...
function DarkRP.hooks:playerUnArrested(ply, actor)
  if ply.Sleeping and GAMEMODE.KnockoutToggle then GAMEMODE:KnockoutToggle(ply, "force"); end
...
hook.Add("PlayerSpawn", "some_unique_name", function(ply) if ply:getDarkRPVar("Arrested") then sendPlayerToJailPos(ply); end end);
