...
local function onLocked(ent)
    ...
    if IsValid(ent:GetParent()) and ent:GetParent():IsVehicle() then ent:GetParent():keysLock() end
end
...
local function onUnlocked(ent)
    ...
    if IsValid(ent:GetParent()) and ent:GetParent():IsVehicle() then ent:GetParent():keysUnLock() end
end
