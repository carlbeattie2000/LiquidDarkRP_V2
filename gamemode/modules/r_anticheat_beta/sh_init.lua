R_ANTICHEAT = R_ANTICHEAT or {} 

R_ANTICHEAT.chatTag = "R_ANTICHEAT"

R_ANTICHEAT.chatTagColor = Color(255, 100, 100)

R_ANTICHEAT.Config = R_ANTICHEAT.Config or {}

R_ANTICHEAT.Config.Net = R_ANTICHEAT.Config.Net or {}
...
-------------------------------------
--/ Seconds to track networking calls, before clearing \--
R_ANTICHEAT.Config.Net.trackingSeconds = 10

--/ Calls before kicking the player, and start counting kicks \--
R_ANTICHEAT.Config.Net.callsBeforeKick = 100

--/ Calls before kicking the player, and start counting kicks \--
R_ANTICHEAT.Config.Net.kicksBeforeBan = 5

--/ Spamming kick message \--
R_ANTICHEAT.Config.Net.kickMessage = "[Anti-Cheat] Spam Prevention |-| Continuation use of sv_allowcslua will result in a ban!"

--/ Spamming ban message \--
R_ANTICHEAT.Config.Net.banMessage = "[Anti-Cheat] You have been banned for cheating(DDOS Attempt)"

--------------------------------------
--     Anti ConVar usage config     --
--------------------------------------
--/ Seconds to check if player has enabled a blacklisted ConVar \--
R_ANTICHEAT.Config.ConVars.checkTime = 20

--/ Random console command length \--
R_ANTICHEAT.Config.ConVars.consoleCommandLength = math.random(10, 100)

--/ Ban length \--
R_ANTICHEAT.Config.ConVars.banLength = 0

--/ Ban message \--
R_ANTICHEAT.Config.ConVars.banMessage = "[Anti-Chat] You have been banned for cheating"
