...
FAdmin.StartHooks["VoiceMute"] = function()
    ...
    end, Color(255, 130, 0, 255), function(ply) return FAdmin.Access.PlayerHasPrivilege(LocalPlayer(), "Voicemute", ply) end, function(ply, button)
    ...
    FAdmin.ScoreBoard.Player:AddActionButton(function(ply) return ply.FAdminMuted and "Unmute voice" or "Mute voice" end, function(ply)
        if ply.FAdminMuted then return "fadmin/icons/voicemute" end
        return "fadmin/icons/voicemute", "fadmin/icons/disable"
    end, Color(255, 130, 0, 255), true, function(ply, button)
