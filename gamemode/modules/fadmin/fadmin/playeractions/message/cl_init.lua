...
FAdmin.StartHooks["zzSendMessage"] = function()
    ...
    FAdmin.ScoreBoard.Player:AddActionButton("Send message", "fadmin/icons/message", Color(0, 200, 0, 255), function(ply) return FAdmin.Access.PlayerHasPrivilege(LocalPlayer(), "Message") and not ply:IsBot() end, function(ply, button) MessageGui(ply) end)
end
