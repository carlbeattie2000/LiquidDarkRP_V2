...
hook.Add("PhysgunPickup", "FAdmin_PickUpPlayers", function(ply, ent)
    ...
    if PlayersCanPickUpPlayers:GetBool() or AdminsCanPickUpPlayers:GetBool() and FAdmin.Access.PlayerHasPrivilege(ply, "PickUpPlayers", ent) and tobool(ply:GetInfo("cl_pickupplayers")) then
