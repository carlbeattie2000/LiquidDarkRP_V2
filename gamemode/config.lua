...
GM.Config.ChatPrefix = "RebbelionRP";
GM.Config.ChatPrefixColor = Color(235, 70, 84, 255);
...
GM.Config.DefaultWeapons = {"keys", "weapon_physcannon", "gmod_camera", "weapon_physgun"};
...
GM.Config.DefaultLaws = {"Do not attack other citizens except in self-defence.", "Do not steal or break in to peoples homes.", "Money printers/drugs are illegal.", "Owing a firearm without license is illegal."};
