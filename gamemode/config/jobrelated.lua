...
TEAM_MOB = AddExtraTeam("Gang Leader", {
  ...
  weapons = {"lockpick", "cracker", "unarrest_stick"},
  command = "mobboss",
  max = 1,
  salary = 170,
  category = "Criminal",
...
TEAM_POLICE = AddExtraTeam("S.W.A.T", {
  ...
  weapons = {"arrest_stick", "unarrest_stick", "weapon_real_cs_mp5a5", "weapon_real_cs_usp", "door_ram", "weaponchecker"},
  command = "swat",
  max = 5,
  salary = 200,
  category = "Law & Order",
...
TEAM_POLICE = AddExtraTeam("S.W.A.T Sniper", {
  ...
  description = [[You are a member of the elite group swat, and speicalise in sniping. You must protect your city and it's citzens no matter the cost.
					Coordinate with the Chief of police, and the swat leader to bring law and order to the city. You are tasked
					with taking down some of the cities most dangerous criminals. Good luck!]],
  weapons = {"arrest_stick", "unarrest_stick", "weapon_real_cs_sg550", "weapon_real_cs_usp", "door_ram", "weaponchecker"},
  command = "swatsniper",
  max = 2,
  salary = 230,
  category = "Law & Order",
...
TEAM_POLICE = AddExtraTeam("S.W.A.T Commander", {
  color = Color(20, 20, 255, 255),
  model = {"models/player/urban.mdl", "models/player/riot.mdl"},
  description = [[You are a member of the elite group swat. You must protect your city and it's citzens no matter the cost.
					Coordinate with the Chief of police an your S.W.A.T Officers to bring law and order to the city. You are tasked
					with taking down some of the cities most dangerous criminals. Good luck!]],
  weapons = {"arrest_stick", "unarrest_stick", "weapon_real_cs_m4a1", "weapon_real_cs_usp", "door_ram", "weaponchecker"},
  command = "swatleader",
  max = 1,
  salary = 240,
  category = "Law & Order",
...
TEAM_MAYOR = AddExtraTeam("Mayor", {
  ...
  description = [[The Mayor of the city creates laws to serve the greater good
		of the people. You can access the mayors computer using !mayor. Please visit the mayors sectary to become this job.]],
  weapons = {},
  command = "mayor",
  max = 1,
  salary = 220,
